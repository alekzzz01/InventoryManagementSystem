...
function NavbarComponent() {
  ...
  return (
    ...
    <nav className="navbar fixed top-0 left-0 right-0 w-full bg-gray-800 text-white lg:py-5 lg:px-20 sm:px-5 px-3 py-4 flex items-center justify-between">
    <div className="flex items-center gap-4">
      ...
      <h1 className="ml-2 text-lg font-regular lg:block hidden">All About Vape Shop</h1>
    </div>
